 ...
 * This is the source of truth for provider types across the codebase.
 */
...
export interface ExecuteOptions {
  ...
  /** @deprecated Use systemPrompt with preset type instead */
...
/**
 * Re-export legacy content block type for backward compatibility
 * @deprecated Use the discriminated union types (TextBlock, ToolUseBlock, etc.) instead
 */
