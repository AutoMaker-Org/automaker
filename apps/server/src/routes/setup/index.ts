...
import { createVerifyZaiAuthHandler, zaiAuthRateLimit } from './routes/verify-zai-auth.js';
...
export function createSetupRoutes(): Router {
  ...
  router.post('/verify-zai-auth', zaiAuthRateLimit, createVerifyZaiAuthHandler());
