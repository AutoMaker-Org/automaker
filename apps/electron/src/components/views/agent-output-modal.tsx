...
export function AgentOutputModal({
  ...
  useEffect(() => {
    ...
    const loadOutput = async () => {
      ...
      try {
        ...
        const result = await services.features.getAgentOutput(
          currentProject.path,
          featureId
        );
  ...
  const saveOutput = async (newContent: string) => {
    if (!projectPathRef.current || !isBootstrapped()) return;
    ...
    try {
      ...
      await services.fileSystem.writeFile(outputPath, newContent);
    } catch (error) {
