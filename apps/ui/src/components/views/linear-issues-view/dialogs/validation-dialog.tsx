...
interface LinearValidationDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  issue: LinearIssue | null;
  validationResult: IssueValidationResult | null;
  onConvertToTask?: (issue: LinearIssue, validation: IssueValidationResult) => void;
}
...
export function LinearValidationDialog({
  open,
  onOpenChange,
  issue,
  validationResult,
  onConvertToTask,
}: LinearValidationDialogProps) {
