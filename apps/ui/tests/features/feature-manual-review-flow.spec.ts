...
test.describe('Feature Manual Review Flow', () => {
  ...
  test('should manually verify a feature in waiting_approval column', async ({ page }) => {
    ...
    // We find the project by path (since the ID is dynamically generated by setupRealProject)
    // and ensure it stays as the current project through reloads.
    await page.route('**/api/settings/global', async (route) => {
      ...
      if (json.settings) {
        ...
        // Find existing project by path (ID is dynamic from setupRealProject)
